var SalesLib = {
    ...
    gravUnits: [{ label: "Plato", value: "PLA" }, { label: "Specific Gravity", value: "SPE" }],

    tempUnits: [{ label: "Fahrenheit", value: "F" }, { label: "Celsius", value: "C" }],

    typeChoices: [{ label: "Lab-grown", value: "Lab-grown" }, { label: "Re-pitching", value: "Custom" }]
};
