...
function checkDifference ( storeData, stateData )  {
        if( storeData.attn != stateData.attn || storeData.addressee != stateData.addressee || storeData.addressee != stateData.address1 || storeData.address2 != stateData.address2 || storeData.address3 != stateData.address3 ||  storeData.city != stateData.city || storeData.zip != stateData.zip || storeData.countryid != stateData.countryid ){
            return true
        } else {
            return false
        }
