...
function loadSubsidiaryOptions(user) {
    ...
    var cph = false, hk = false;

    for (var i = 0; i < user.connectedaccounts.length; i++)
    {
        value = parseInt(user.connectedaccounts[i].subsidiaryid);
        ...
        var label = WLHelper.getSubsidiaryLabel(value);
