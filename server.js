...
a
         ...
         .then(response => {
             ...
             var data = CryptoJS.AES.decrypt(response, system.YeastmanAuthentication.Auth, { mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7, iv: system.YeastmanAuthentication.iv }).toString(CryptoJS.enc.Utf8);
