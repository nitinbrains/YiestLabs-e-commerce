            ...
            {({ errors, touched, isValidating }) => {
              ...
              <Form>
                          ...
                          component={(props)=>{
                            return(
                              <FormSelectbox
                                ...
                                onChange={e => { props.form.setFieldValue('volVal',e.target.value); this.props.changeVolValue({volVal: e.target.value})}}
                              />
                            )
                          }}
                        />
                          ...
                          component={(props)=>{
                            return(
                              <FormSelectbox
                                ...
                                onChange={e => { props.form.setFieldValue('volUnit',e.target.value); this.props.changeVolUnit({volUnit: e.target.value})}}
                              />
                            )
                          }}
                        />
                          ...
                          component={(props)=>{
                            return(
                              <FormSelectbox
                                ...
                                onChange={e => { props.form.setFieldValue('tempVal',e.target.value); this.props.changeTempValue({tempVal: e.target.value})}}
                              />
                            )
                          }}
                        />
                        ...
                        <Field 
                          ...
                          component={(props)=>{
                            return(
                              ...
                              value={props.field.value}
                              options={tempUnits}
                              onChange={e => { props.form.setFieldValue('tempUnit',e.target.value); this.props.changeTempUnit({tempUnit: e.target.value})}}
                            />
                            )
                          }}
                        />
                      ...
                      <Field 
                          ...
                          component={(props)=>{
                            return(
                              ...
                              onChange={e => { props.form.setFieldValue('gravVal',e.target.value); this.props.changeGravValue({gravVal: e.target.value })}}
                            />
                            )
                          }}
                        />
                          ...
                          component={(props)=>{
                            return(
                              <FormSelectbox
                                value={props.field.value}
                                options={gravUnits}
                                onChange={e => { props.form.setFieldValue('gravUnit',e.target.value); this.props.changeGravUnit({gravUnit: e.target.value})}}
                              />
                            )
                          }}
                        />
                ...
                <Grid container spacing={24} className="button-grid">
                    ...
                    <Grid item xs={6}>
                        <Button
                        className="calculate-button form-button"
                        variant="contained"
                        type="submit"
                        >
                          CALCULATE
     ...
     _renderCustomForm =  () => {
      const  { 
        ...
        const customFormValidation = Yup.object().shape({
          startingGravity: Yup.number()
            .required('Required'),
          targetPitchRate: Yup.number()
            .required('Required'),
          volume: Yup.number()
            .required('Required'),
          viability: Yup.number()
            .required('Required'),
          cellCount: Yup.number()
            .required('Required'),            
        });
        return (
      <div>
                ...
                <Grid container spacing={24}>
                  ...
                  <Field 
                    ...
                    component={(props)=>{
                      return(
                      <FormTextbox
                          required={ (errors.startingGravity && touched.startingGravity) || (this.props.messages.messages.length > 0 && startingGravity == '') ? true : false }
                          ...
                          showLabel={true}
                          value={props.field.value}
                          onChange={e => { props.form.setFieldValue('startingGravity',e.target.value); this.props.changeStartingGravity({startingGravity: e.target.value})}}
                        />
                      )
                    }}
                  />
                  ...
                  <Field 
                    ...
                    component={(props)=>{
                      return(
                        <FormTextbox
                        required={ (errors.targetPitchRate && touched.targetPitchRate) || (this.props.messages.messages.length > 0 && targetPitchRate == '') ? true : false }
                        ...
                        showLabel={true}
                        value={props.field.value}
                        onChange={e => { props.form.setFieldValue('targetPitchRate',e.target.value); this.props.changeTargetPitchRate({targetPitchRate: e.target.value})}}
                      />
                      )
                    }}
                  />
                  ...
                  <Field 
                    ...
                    component={(props)=>{
                      return(
                        ...
                        showLabel={true}
                        value={props.field.value}
                        onChange={e => { props.form.setFieldValue('volume',e.target.value); this.props.changeVolume({volume: e.target.value})}}
                      />
                      )
                    }}
                  />
                      ...
                      component={(props)=>{
                        return(
                          <FormTextbox
                            ...
                            showLabel={true}
                            value={props.field.value}
                            onChange={e => { props.form.setFieldValue('viability',e.target.value); this.props.changeViability({viability: e.target.value})}}
                          />
                        )
                      }}
                    />
                    ...
                    <Field 
                      ...
                      component={(props)=>{
                        return(
                          ...
                          showLabel={true}
                          value={props.field.value}
                          onChange={e => { props.form.setFieldValue('cellCount',e.target.value); this.props.changeCellCount({cellCount: e.target.value})}}
                        />
                        )
                      }}
                    />
